...
const PropertyCategoriesDetail: React.FC = () => {
  ...
  useEffect(() =>  {
    if (currentUserPermissions?.propertyCategoriesView)
      return;
    ...
    const fetchData = async () => {
      try {
        ...
        if (response.code === 200) {
          ...
          if (!response.permissions.propertyCategoriesView) {
  ...
  return (
    <>
    {currentUserPermissions?.propertyCategoriesView || viewAllowed ? (
      <>
        { loading ? (
